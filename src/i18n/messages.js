...
export const messages = {
  vi: {
    ...
    siteLog: {
      ...
      mainTasksHint: 'Lưu Google Sheet · tab DAILY_SITE_LOG',
      editMainTask: 'Sửa',
      deleteMainTask: 'Xóa',
      items: 'hạng mục',
  ...
  en: {
    ...
    siteLog: {
      ...
      mainTasksHint: 'Saved to Google Sheet · DAILY_SITE_LOG tab',
      editMainTask: 'Edit',
      deleteMainTask: 'Delete',
      items: 'items',
      noRecord: 'No records',
      incidents: 'Incidents',
    ...
    moduleDate: {
      ...
      pickDate: 'Pick date from calendar',
      saving: 'Saving...',
      saved: 'Saved',
