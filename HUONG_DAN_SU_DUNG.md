...
**Dashboard VPEG-PXD** là nền tảng quản lý dự án điện mặt trời EPC của **vũ phong (by Tien Nguyen)**. Phần mềm giúp:
...
- **Không hiện** trên link chia sẻ khách — chỉ nội bộ vũ phong.
...
| **Phân quyền** | PM/SM toàn quyền dự án được gán; dự án khác chỉ xem |
...
*Tài liệu thuộc **vũ phong (by Tien Nguyen)** — VPEG-PXD Dashboard. Cập nhật khi phát hành phiên bản mới.*
